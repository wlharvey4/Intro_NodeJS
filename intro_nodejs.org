...
#+AUTHOR:Azat Mardan
#+VERSION:0.0.5 <2019-04-27 Sat 23:03>
...
{{{heading(Node Modules with ~require~ and ~module.exports~)}}}
...
{{{subheading(Node.js Modules---~require~---~module.exports~)}}}
